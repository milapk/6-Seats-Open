    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('betting_stage', models.PositiveSmallIntegerField(choices=[(0, 'Pre-flop'), (1, 'Flop'), (2, 'Turn'), (3, 'River'), (4, 'Showdown'), (5, 'New Round')], default=0)),
                ('dealer_position', models.PositiveIntegerField(default=0)),
                ('community_cards', models.CharField(blank=True, max_length=14)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chips_claimed', models.DateTimeField(default=django.utils.timezone.now)),
        ...
        migrations.AddField(
            ...
            name='current_turn',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.playermodel'),
        ),
        migrations.CreateModel(
            name='PotModel',
            fields=[
